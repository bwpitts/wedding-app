...
var headerImage = '../../assets/images/header-image.jpg';
var footerImage = '../../assets/images/footer-image.jpg';
        ...
        return(
            <Container>
                ...
                <Content contentContainerStyle={{
                    ...
                    <Image source={require(headerImage)} style={{width: "100%", height: 250, marginBottom: 15}}/>
                    ...
                    <Image source={require(footerImage)} style={{width: "100%", height: 250}}/>
                </Content>
            </Container>
        )
    }
